...
完整的产品文档体系，帮助Agent快速上手OpenTrace。
...
| [OPENTRACE_GUIDE.md](../../OPENTRACE_GUIDE.md) | 完整使用指南 - 详细说明和示例 | 深入了解时 |
...
| [.claude/skills/opentrace-data-analysis.md](../../.claude/skills/opentrace-data-analysis.md) | Skill定义 |
...
├── 🚀 快速开始
│   ├── README.md              - 项目概述
│   ├── opentrace/doc/AGENT_GUIDE.md    - Agent专用指南 ⭐
│   └── opentrace/doc/QUICKSTART.md    - 快速开始
│
├── 📖 详细文档
│   ├── opentrace/doc/API_REFERENCE.md  - API速查手册
│   ├── opentrace/doc/BEST_PRACTICES.md - 最佳实践
│   └── OPENTRACE_GUIDE.md              - 完整指南
│
├── 🔧 配置和工具
